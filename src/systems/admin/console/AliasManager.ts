 ...
 *
 *  - Alias simple : "k" -> "kick"
 *  - Macro multi-commandes : "cleanup" -> ["mute {0}", "warn {0} spam", "kick {0}"]
 *  - Substitution de paramètres positionnels : {0}, {1}, {*} (tout le reste)
 *  - expand(raw) -> liste de commandes finales à exécuter dans l'ordre
 *  - Protection anti-récursion (profondeur max)
 *  - Sérialisable
 * ----------------------------------------------------------------------------
 */
